        ...
        <section class="content">
            ...
            <div class="card">  
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-6">
                            <strong class="text-danger">CHI TIẾT LOẠI SẢN PHẨM</strong>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="mb-3">
                                ...
                                <input name="data[name]" value="<?php echo $row['name'] ?>" id="name" type="text" required class="form-control" placeholder="Nhập tên loại" />
                            </div>
                            <div class="mb-3">
