                    ...
                    <tbody>
                        <?php foreach ($list as $row) : ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="index.php?option=page&cat=retrash&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-info">
                                        <i class="fas fa-trash-restore"></i>
                                    </a>
                                    <a href="index.php?option=page&cat=delete&id=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger">
