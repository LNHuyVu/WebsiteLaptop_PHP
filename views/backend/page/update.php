                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="data[detail]" id="detail" rows="8" class="form-control"><?php echo $row['detail'] ?></textarea>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="md-3">
                            ...
                            <div class="md-3">
                                ...
                                <input name="img" type="file" value="<?php echo $row['img'] ?>" id="img"></input>
                            </div>
                            <!-- <div class="md-3">
